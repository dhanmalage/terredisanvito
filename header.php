...
<header style="<?php echo ((is_home() || is_front_page()) ? 'background-color: #000000;' : 'background-color: transparent; background-image: url('.get_template_directory_uri().'/images/our-farm-background.jpg);'); ?>">
